...
export const COMPOSE_CHANGE_LOC      = 'COMPOSE_CHANGE_LOC';
...
export function changeComposeLOC(text) {
  return {
    type: COMPOSE_CHANGE_LOC,
    text: text,
  };
};
...
export function submitCompose(routerHistory) {
  return function (dispatch, getState) {
    ...
    const locID =  processLocID(getState().getIn(['compose', 'locID'], null));
