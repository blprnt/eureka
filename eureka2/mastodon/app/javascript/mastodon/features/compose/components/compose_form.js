...
import AutosuggestTextareaLOC from '../../../components/autosuggest_textarea_loc';
...
class ComposeForm extends ImmutablePureComponent {
  ...
  handleChangeLOC = (e) => {
    ...
    this.props.onChangeLOC(e.target.value);
  }
  ...
  setAutosuggestTextareaLOC = (c) => {
    this.autosuggestTextareaLOC = c;
  }
      ...
      <div className='compose-form'>
        ...
        <div className ='compose-form-loc'>
          <AutosuggestTextareaLOC
            ...
            suggestions={this.props.suggestions}
            onKeyDown={this.handleKeyDownLOC}
            onSuggestionsFetchRequested={this.onSuggestionsFetchRequested}
            onSuggestionsClearRequested={this.onSuggestionsClearRequested}
            onSuggestionSelected={this.onSuggestionSelected}
            onPaste={onPaste}
